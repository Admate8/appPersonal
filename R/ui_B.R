ui_B <- bslib::nav_panel(
  ...
  bslib::navset_card_pill(
    ...
    #bslib::nav_panel("Income Allocation", echarts4r::echarts4rOutput("plot_allocations_over_time", height = "500px") |> shinycssloaders::withSpinner(color = spinners_colour, size = 1.5))
  )
)
